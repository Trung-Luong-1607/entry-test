...
public class Video extends Thing {
	...
	public Video(String serialNumber, String skuCode, String productName, String manufacturer, String origin, int price,
			int quantity, String category, String capacity) {
